...
#line hidden
#line 6
        testRunner.When(string.Format("preencho o usuario como {0} PO", usuario), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 7
        testRunner.And(string.Format("a senha {0} e clico no botão Login PO", senha), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 8
...
#line hidden
#line 10
        testRunner.And("clico no icone do carriho de compra PO", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 11
        testRunner.Then(string.Format("exibe a pagina do carrinho com a quantidade {0} PO", quantidade), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 12
